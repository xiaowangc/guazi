...
public class SendSms {
    ...
    public static boolean send(String phoneNumber,String code) {
        DefaultProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAI4FhmBqL3PtAXu5sxbH2N", "kidAtcuHPtzuVUaCZCeUZsy7ssakN2");
        ...
        request.putQueryParameter("TemplateCode", "SMS_181490950");
        //{"code":code,"address":"校园集散中心","phone":"13672749791"}
