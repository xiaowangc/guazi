...
<%--        <script>--%>
<%--            window.alert("请先进行登录！" + ${sessionScope.manager});--%>
<%--            window.location.href = "login.jsp";--%>
<%--        </script>--%>
<%--    </c:if>--%>
<%--增加index.jsp页面入口的验证，防止直接访问网址--%>
        <%
        if(!SessionUtil.getManageFlag(session)){
        %>
                <script>
                    window.alert("请先进行登录！");
                window.location.href = "login.jsp";
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side-scroll">
            ...
            <ul id="Nav" class="layui-nav layui-nav-tree">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="console.do"><i class="layui-icon">&#xe665;</i> 控制台</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="courierList.do?flag=1"><i class="layui-icon">&#xe60a;</i> 快递员列表</a></dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="queryAll"><i class="layui-icon">&#xe60a;</i> 快件列表</a></dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="userList.do?flag=0"><i class="layui-icon">&#xe60a;</i> 用户列表</a></dd>
    ...
    <div class="layui-footer">
        <p>©2019 <a href="http://www.baidu.com" target="_blank">驰哥公司版权声明</a></p>
    </div>
