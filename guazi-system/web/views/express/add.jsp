...
<%--                        <button class="layui-btn layui-btn-blue" lay-submit lay-filter="formDemo">立即提交</button>--%>
                        <input type="button" class="layui-btn layui-btn-blue" lay-filter="formDemo" onclick="add()">立即提交</input>
...
<script>
    ...
    function add() {
        ...
        $.post("../../express/add.do","number="+number+"&company="+company+"&name="+name+"&phone=" + phone,function (data){
